...
function sortByDuration(data, flightLength){
  let abvData = data.map(podcast => {return{
      title: podcast.title,
...
if(flightLength <= 60){
    console.log(abvData.sort((a,b) => a.duration - b.duration ))
}

else if(flightLength > 60){
    console.log(abvData.sort((a,b) => b.duration - a.duration))
}
}
